...
// Pagina flagship per i developer: gli MCP server open source di Open·Parlamento.
...
export default function McpServer() {
  ...
  const ld = [
    softwareApplication({
      name: 'Open·Parlamento MCP servers',
      description: t.desc,
    ...
    faqPage(t.faq),
    breadcrumb(lang === 'en'
      ? [['Open·Parlamento', '/en'], ['MCP server', t.path]]
      : [['Open·Parlamento', '/'], ['Documentazione', '/docs'], ['MCP server', t.path]]),
  ]
      ...
      <main className="docs-content">
        <article className="docs-article">
          <div className="crumbs-mini" style={{ fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--muted)', marginBottom: 14 }}>
            <a href={lang === 'en' ? '/en' : '/'}>Open·Parlamento</a> › <span>MCP server</span>
          </div>
