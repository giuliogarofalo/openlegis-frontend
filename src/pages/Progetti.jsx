...
// Pagina «Progetti & librerie»: lista i progetti open source di Open·Parlamento, con
...
const LINKS = {
  site: 'https://openlegis.it',            // il monorepo (webapp+agent) è privato: la voce "Open·Parlamento" punta al sito, non a GitHub
...
export default function Progetti() {
  ...
  const ld = [
    ...
    faqPage(t.faq),
    breadcrumb(lang === 'en'
      ? [['Open·Parlamento', '/en'], ['Projects', t.path]]
      : [['Open·Parlamento', '/'], ['Progetti', t.path]]),
  ]
