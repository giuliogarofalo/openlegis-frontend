...
export default {
  ...
  desc: 'Due MCP server open source per interrogare legge italiana, Costituzione, diritto UE e dati del Parlamento da Claude, Cursor e altri client: republic-mcp (npm) e openlegis-mcp (PyPI).',
  kicker: 'open source · model context protocol',
  h1: 'MCP server per la legge e il Parlamento italiano',
  lead: 'OpenLegis pubblica due server MCP open source che portano la legge italiana, il diritto UE e i dati del Parlamento dentro qualsiasi client compatibile — Claude Desktop, Cursor, e gli altri.',
  ...
  faq: [
    { q: 'Gli MCP server di OpenLegis sono open source?', a: 'Sì. Il codice è pubblicato con licenza MIT su GitHub; i pacchetti sono su npm (republic-mcp) e PyPI (openlegis-mcp).' },
    { q: 'Come installo l’MCP server in Claude Desktop?', a: 'Aggiungi una voce in mcpServers nel file di configurazione: per republic-mcp usa il comando "npx -y republic-mcp"; per openlegis-mcp installa con pip e usa il comando "openlegis-mcp".' },
