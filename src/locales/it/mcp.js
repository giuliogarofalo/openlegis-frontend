...
export default {
  ...
  faq: [
    { q: 'Gli MCP server di OpenLegis sono open source?', a: 'Sì. Il codice è pubblicato con licenza MIT su GitHub; i pacchetti sono su npm (republic-mcp) e PyPI (open-parlamento-mcp).' },
