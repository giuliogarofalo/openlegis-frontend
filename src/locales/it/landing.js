...
export default {
  ...
  faq: [
    [
      ...
      "L'articolo 11 della Costituzione italiana stabilisce che l'Italia ripudia la guerra come strumento di offesa alla libertà degli altri popoli e come mezzo di risoluzione delle controversie internazionali. Open·Parlamento riporta il testo dell'articolo con il riferimento citabile (ELI).",
    ],
    [
      'A che punto è un disegno di legge?',
      'Open·Parlamento interroga i dati aperti di Camera e Senato (SPARQL) e restituisce lo stato di avanzamento di un DDL, i firmatari e l’iter parlamentare, con link alla fonte ufficiale.',
    ],
    [
    ...
    [
      'Open·Parlamento è una consulenza legale?',
