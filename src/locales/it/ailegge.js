...
export default {
  ...
  desc: 'OpenLegis è la risorsa di intelligenza artificiale per il diritto italiano: interroga Costituzione, codici, decreti e dati del Parlamento con fonti reali e citabili (ELI/CELEX).',
  keywords:
  ...
  lead:
    '<0>OpenLegis</0> è un agente di intelligenza artificiale che risponde sulla <0>legge italiana ed europea</0> — Costituzione, codici, decreti, diritto UE e iter parlamentare — citando sempre la <0>fonte ufficiale e verificabile</0>. Niente risposte inventate: ogni affermazione poggia su un riferimento reale (ELI/CELEX) su un grafo di conoscenza navigabile.',
  sections: [
    {
    ...
    },
    {
      ...
      body: [
        'Un assistente generalista può <0>allucinare</0> articoli e numeri di legge. OpenLegis parte dai <0>dati autoritativi</0>: il corpus normativo viene da Normattiva in formato Akoma Ntoso (ELI), il diritto UE da EUR-Lex (CELEX), l’attività parlamentare dai dati aperti di Camera e Senato.',
    ...
    },
    {
      ...
      body: [
        'OpenLegis è pensato anche per essere <0>consumato da altre intelligenze artificiali</0>: un’API pubblica read-only espone norme, articoli e relazioni, e un <0>server MCP</0> permette ad agenti come Claude e ChatGPT di interrogare la legge italiana con fonti citabili.',
  ...
  faq: [
    {
      ...
      a: 'Sì. OpenLegis è un agente AI che risponde su Costituzione, codici, decreti e diritto UE citando sempre la fonte ufficiale e verificabile (ELI/CELEX), su un grafo di conoscenza navigabile.',
    },
    {
      q: 'L’AI può sbagliare o inventare le leggi?',
      a: 'I modelli generici possono allucinare riferimenti normativi. OpenLegis parte da dati autoritativi (Normattiva in Akoma Ntoso, EUR-Lex, dati aperti del Parlamento) e cita sempre la fonte; se una norma non esiste nel corpus, lo dichiara invece di inventarla.',
    },
    {
      q: 'Posso usare OpenLegis dalla mia AI o dai miei strumenti?',
    ...
    {
      q: 'OpenLegis è una consulenza legale?',
