...
// Lista i progetti open source di Open·Parlamento. RepublicMCP è l'origine del progetto.
// Ogni voce: [nome, registry/tipo, descrizione, chiave-link (vedi LINKS in Progetti.jsx), badge].
export default {
  lang: 'it', path: '/progetti',
  title: 'Progetti & librerie open source di Open·Parlamento',
  desc: 'I progetti e le librerie open source dietro Open·Parlamento: RepublicMCP (l’origine), republic-mcp su npm, open-parlamento-mcp su PyPI e il grafo delle relazioni. Codice Apache-2.0, fonti pubbliche.',
  kicker: 'open source · npm · PyPI · GitHub',
  h1: 'Progetti & librerie',
  lead: 'Open·Parlamento è reuse-first e open source. Qui trovi i miei progetti e le librerie pubblicate — codice Apache-2.0, dati da fonti ufficiali e citabili. Tutto è installabile e ispezionabile.',
  ...
  mine: [
    ['Open·Parlamento', 'openlegis.it', 'Il progetto: agente con function-calling, connettori, knowledge graph e webapp. Lo strato che rende interrogabili fonti che, da sole, non lo sono. Il monorepo è privato — il codice riusabile è nei progetti pubblici qui sotto.', 'site', 'attivo'],
    ...
    ['open-parlamento-mcp', 'GitHub · Python', 'Il server MCP della legge e dei dati: Costituzione e codici, modifiche Normattiva, iter, giurisprudenza UE/Consulta/Cassazione/TAR-CdS, statistiche, Gazzetta Ufficiale, dati CKAN, OpenPolis, PNRR (anche aggiudicazioni appalti) — 25 tool. Su PyPI: «pip install open-parlamento-mcp».', 'openParlamentoMcpGithub', 'pubblicato'],
  ],
  ...
  relatedH: 'Vedi anche',
  faq: [
    { q: 'Qual è il progetto da cui è nato Open·Parlamento?', a: 'RepublicMCP: il server MCP che espone Camera e Senato via SPARQL. Mappando le ontologie OCD e OSR è nata l’idea di unire legge e dati in un unico grafo interrogabile.' },
    { q: 'I progetti sono open source?', a: 'Sì. Il codice è pubblicato con licenza Apache-2.0 su GitHub; i pacchetti sono su npm (republic-mcp) e PyPI (open-parlamento-mcp). I dati provengono da fonti pubbliche e citabili.' },
    { q: 'Posso usare le librerie senza la webapp?', a: 'Sì. I server MCP sono autonomi: «npx -y republic-mcp» o «pip install open-parlamento-mcp», poi configurali nel tuo client MCP. Funzionano indipendentemente dal sito.' },
  ],
