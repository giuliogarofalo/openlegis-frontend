...
export default {
  ...
  desc: 'I progetti e le librerie open source dietro OpenLegis: RepublicMCP (l’origine), republic-mcp su npm, open-parlamento-mcp su PyPI e il grafo delle relazioni. Codice Apache-2.0, fonti pubbliche.',
