...
export default {
  ...
  desc: 'API REST read-only e gratuita sui dati aperti di OpenLegis: norme, testo per-articolo, relazioni di modifica e knowledge graph. Solo GET, con OpenAPI/Swagger. Licenza CC BY 4.0.',
