...
export default {
  ...
  title: 'Support Open·Parlamento',
  desc: 'Open·Parlamento is an open-source, free and independent project: making the Italian State queryable by anyone, with real sources. Here is how you can support and contribute.',
  kicker: 'open source · independent',
  h1: 'Support Open·Parlamento',
  lead: 'Open·Parlamento is open source, free and independent. The idea is simple: the State — law and data — should be queryable by anyone, not just insiders. Here is how you can help.',
  ways: [
  ...
  infraP: 'Beyond the website, Open·Parlamento ships reusable components: two open-source MCP servers (npm and PyPI), a read-only public API, citable open data (ELI/CELEX, Akoma Ntoso) and a knowledge graph. Open standards, reusable by other projects, beyond Italy too.',
  ctaRepo: 'Code on GitHub ↗', ctaContribuisci: 'How to contribute',
  relH: 'See also',
  faq: [
    { q: 'Is Open·Parlamento free?', a: 'Yes, it is free and open source (MIT license). Data is public and citable.' },
