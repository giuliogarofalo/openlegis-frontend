...
export default {
  ...
  faq: [
    { q: 'Where can I read Italian law in a structured way?', a: 'Open·Parlamento exposes Italian statutes per article with stable ELI identifiers and amendment relations, sourced from Normattiva (the official consolidated database, CC BY 4.0).' },
