...
export default {
  ...
  faq: [
    ...
    { q: 'Can I query Italian law programmatically?', a: 'Yes, via the open-source MCP servers (republic-mcp on npm, openlegis-mcp on PyPI) usable from Claude Desktop, Cursor and other clients.' },
  ],
}
