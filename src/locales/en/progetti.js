...
// Lists Open·Parlamento's open-source projects. RepublicMCP is where it all began.
// Each item: [name, registry/type, description, link-key (see LINKS in Progetti.jsx), badge].
export default {
  lang: 'en', path: '/en/projects',
  title: 'Open-source projects & libraries behind Open·Parlamento',
  desc: 'The open-source projects and libraries behind Open·Parlamento: RepublicMCP (the origin), republic-mcp on npm, open-parlamento-mcp on PyPI and the relations graph. Apache-2.0 code, public sources.',
  kicker: 'open source · npm · PyPI · GitHub',
  h1: 'Projects & libraries',
  lead: 'Open·Parlamento is reuse-first and open source. Here are my projects and published libraries — Apache-2.0 code, data from official and citable sources. Everything is installable and inspectable.',
  ...
  mineH: 'My projects',
  mine: [
    ['Open·Parlamento', 'openlegis.it', 'The project: a function-calling agent, connectors, knowledge graph and webapp. The layer that makes queryable the sources that, on their own, are not. The monorepo is private — the reusable code lives in the public projects below.', 'site', 'active'],
  ...
  relatedH: 'See also',
  faq: [
    { q: 'Which project did Open·Parlamento grow out of?', a: 'RepublicMCP: the MCP server that exposes the Chamber and Senate over SPARQL. Mapping the OCD and OSR ontologies sparked the idea of uniting law and data into a single queryable graph.' },
